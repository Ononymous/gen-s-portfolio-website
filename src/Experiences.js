...
import { Text, Stack, Heading, Box, ListItem, UnorderedList, Button, Link, Menu, MenuList, MenuButton, MenuOptionGroup, MenuItemOption } from "@chakra-ui/react";
import "./App.css"
...
function Past(){
    ...
    return(
        ...
        className={colorMode==="light"?"experiences":"experiences-dark"}>
            ...
            <Box boxShadow="inner" rounded={"2xl"} w="fill" border='1px' borderColor='gray.200'>
                <Stack direction="row">
                    <Menu closeOnSelect={false}>
                        ...
                        <MenuList minWidth='240px'>
                            <MenuOptionGroup defaultValue='all' title='Type' type='radio'>
